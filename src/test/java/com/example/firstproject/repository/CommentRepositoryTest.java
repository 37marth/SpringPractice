...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        /* Case 3 : 9번 게시글의 모든 댓글 조회*/
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected,comments,"9번글의 댓글은 존재하지 않음");
        }
        /* Case 4 : 999번 게시글의 모든 댓글 조회*/
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected,comments,"-1번글은 존재하지 않음");
        }
        /* Case 5 : -1번 게시글의 모든 댓글 조회*/
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected,comments,"999번글은 존재하지 않음");
        }
    }
    ...
    void findByNickname() {
        /* Case 1 : "Park"의 모든 댓글 조회*/
        {
            ...
            Comment a = new Comment(1L,article4,"Park","굿 윌 헌팅");
        ...
        /* Case 3 : null의 모든 댓글 조회(특정 닉네임의 입력값이 null일 때)*/
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected,comments,"닉네임이 null이면 빈 리스트 반환");
        }/* Case 4 : ""의 모든 댓글 조회(특정 닉네임의 입력값이 없을때)*/
        {
            //1. 입력 데이터 준비
            String nickname = "";
            //2. 실제 데이터
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected,comments,"닉네임이 빈 문자열이면 빈 리스트 반환");
        }
    }
}